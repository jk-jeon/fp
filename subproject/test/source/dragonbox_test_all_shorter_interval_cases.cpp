...
{
	using ieee754_traits = jkj::fp::ieee754_traits<Float>;
	using ieee754_format_info = jkj::fp::ieee754_format_info<ieee754_traits::format>;
		...
		e <= ieee754_format_info::max_exponent; ++e)
	{
		...
		auto x = jkj::fp::ieee754_bits<Float>{ br }.to_float();
...
int main()
{
	...
	std::cout << "[Testing Dragonbox for all shorter interval cases for binary32...]\n";
	success &= test_all_shorter_interval_cases_impl<float>();
	std::cout << "Done.\n\n\n";

	std::cout << "[Testing Dragonbox for all shorter interval cases for binary64...]\n";
